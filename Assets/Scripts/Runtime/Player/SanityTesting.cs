...
public class Sanitytesting: MonoBehaviour
{
    ...
    [SerializeField] private float sanityDamageInterval = 2f;

    [SerializeField] private float sanityDrainPerSecond = 7f;
    [SerializeField] private float sanityRecoveryPerSecond = 10f;

    [SerializeField] private SphereCollider sanityDetector;
    ...
    [SerializeField] private float heartbeatLowSanity = 34f;
